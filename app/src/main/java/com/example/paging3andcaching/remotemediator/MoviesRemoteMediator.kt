package com.example.paging3andcaching.remotemediator
...
import com.example.paging3andcaching.caching.RemoteKeys
...
class MoviesRemoteMediator(
    ...
    /*initialize this method is to check whether cached data is out of date and decide whether to trigger a
     remote refresh. This method runs before any loading is performed, so you can manipulate the
     database (for example, to clear old data) before triggering any local or remote loads.*/
